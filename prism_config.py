...
MODULES = {
    "ai": {
        "name": "🤖 AI 对话系统",
        "enabled": True,
        "features": ["多角色", "多语言", "连续对话", "版本管理", "数据保存"]
    },
    "economy": {
        "name": "💰 经济系统",
        "enabled": True,
        "features": ["挖矿", "钓鱼", "狩猎", "赌博", "宠物", "市场"]
    },
    "games": {
        "name": "🎮 娱乐游戏",
        "enabled": True,
        "features": ["Pokemon猜谜", "Trivia", "动漫角色", "数字游戏", "动漫查询", "互动动作"]
    },
    "admin": {
        "name": "⚙️ 管理工具",
        "enabled": True,
        "features": ["日志", "清理", "欢迎消息", "配置", "自定义命令"]
    },
    "music": {
        "name": "🎵 音乐系统",
        "enabled": False,  # 可选 - 需要 Lavalink
...
# 宠物系统
PETS = {
    "猫": {"emoji": "🐱", "mood_boost": 1.1},
    "狗": {"emoji": "🐕", "mood_boost": 1.15},
    "龙": {"emoji": "🐉", "mood_boost": 1.5}
}
...
# ==================== 管理系统常量 ====================
LOG_FILE_FORMAT = "logs/prism_{date}.log"
